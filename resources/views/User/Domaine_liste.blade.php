                            ...
                            <div class="table-responsive border rounded">
                                <div class="table-responsive my-3">
                                    <table id="domain-list-table" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th class="sorting">Domain Name</th>
                                                <th class="sorting">Registration Date</th>
                                                <th class="sorting">Expiration Date</th>
                                                <th class="sorting">Status</th>
                                                <th style="min-width: 100px" class="sorting">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('domain.Transfer.view') }}">Transfer</a></li>
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('domain.Renew.view') }}">Renew</a></li>
