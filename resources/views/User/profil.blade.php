...
@section('beforecontente')
    ...
    <div class="iq-navbar-header " style="height: 215px;">
        ...
        <div class="iq-header-img">
            <img src="{{ asset('assets1/images/header/top-header.png') }}" alt="header"
            ...
            <img src="{{ asset('assets1/images/header/top-header2.png') }}" alt="header"
                class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
            <img src="{{ asset('assets1/images/header/top-header3.png') }}" alt="header"
                class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
            <img src="{{ asset('assets1/images/header/top-header4.png') }}" alt="header"
                class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
            <img src="{{ asset('assets1/images/header/top-header5.png') }}" alt="header"
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                                    ...
                                    <img src="{{ asset('assets1/images/avatars/02.png') }}" alt="User-Profile"
                                        class="theme-color-purple-img img-fluid rounded-pill avatar-100" loading="lazy">
                                    <img src="{{ asset('assets1/images/avatars/03.png') }}" alt="User-Profile"
                                        class="theme-color-blue-img img-fluid rounded-pill avatar-100" loading="lazy">
                                    <img src="{{ asset('assets1/images/avatars/04.png') }}" alt="User-Profile"
                                        class="theme-color-green-img img-fluid rounded-pill avatar-100" loading="lazy">
                                    <img src="{{ asset('assets1/images/avatars/05.png') }}" alt="User-Profile"
                                        class="theme-color-yellow-img img-fluid rounded-pill avatar-100" loading="lazy">
                                    <img src="{{ asset('assets1/images/avatars/06.png') }}" alt="User-Profile"
                            ...
                            <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider"
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link show" data-bs-toggle="tab" href="#profile-feed" role="tab"
                                        aria-selected="false" tabindex="-1">Feed</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#profile-activity" role="tab"
                                        aria-selected="false" tabindex="-1">Activity</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#profile-friends" role="tab"
                                        aria-selected="false" tabindex="-1">Friends</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab"
                                        aria-selected="false" tabindex="-1">Profile</a>
                                </li>
                                <div class="nav-slider-thumb position-absolute nav-link"
                                    style="padding: 0px; width: 61px; height: 33px; transform: translate3d(0px, 0px, 0px); transition: 300ms ease-in-out;"
                                    aria-selected="false" tabindex="-1" role="tab"><a class="nav-link active show"
                                        data-bs-toggle="tab" href="#profile-feed" role="tab"
                                        aria-selected="true"></a></div>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="header-title">
                                    <div class="d-flex flex-wrap">
                                        <div class="media-support-user-img me-3">
                                            <img class="rounded-pill img-fluid avatar-60 bg-danger-subtle p-1"
                                                src="{{ asset('assets1/images/avatars/02.png') }}" alt=""
                                                loading="lazy">
                                        </div>
                            ...
                            <div class="card-body p-0">
                                <div class="user-post">
                                    <a href="javascript:void(0);"><img
                                            src="{{ asset('assets1/images/pages/03-page.jpg') }}"alt="post-image"
                                ...
                                <div class="comment-area p-3">
                                    ...
                                    <ul class="list-inline p-0 m-0">
                                        <li class="mb-2">
                                            <div class="d-flex">
                                                <img src="{{ asset('assets1/images/avatars/03.png') }}" alt="userimg"
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{ asset('assets1/images/avatars/04.png') }}" alt="userimg"
                            ...
                            <div class="card-body">
                                <ul class="list-inline m-0 p-0">
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="{{ asset('assets1/images/avatars/01.png') }}" alt="story-img"
                                    ...
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="{{ asset('assets1/images/avatars/05.png') }}" alt="story-img"
                                            class="rounded-pill avatar-40" loading="lazy">
                                        <div class="ms-3 flex-grow-1">
                                            <h6>Paul Molive</h6>
                                    ...
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="{{ asset('assets1/images/avatars/02.png') }}" alt="story-img"
                                            class="rounded-pill avatar-40" loading="lazy">
                                        <div class="ms-3 flex-grow-1">
                                            <h6>Anna Mull</h6>
                                    ...
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="{{ asset('assets1/images/avatars/03.png') }}" alt="story-img"
                                            class="rounded-pill avatar-40" loading="lazy">
                                        <div class="ms-3 flex-grow-1">
                                            <h6>Paige Turner</h6>
                                            <p class="mb-0">trainee</p>
                                    ...
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="{{ asset('assets1/images/avatars/04.png') }}" alt="story-img"
                                            class="rounded-pill avatar-40" loading="lazy">
                                        <div class="ms-3 flex-grow-1">
                                            <h6>Barb Ackue</h6>
                                            <p class="mb-0">Web Designer</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <div>
                                        <img src="{{ asset('assets1/images/avatars/01.png') }}" alt="profile-img"
